        ...
        <div class="card-body">
          ...
          <h3 class="mb-75 mt-2 pt-50">
            <a href="#">
              ...
              <?php 
                if($doanhthungay > 0) {
                     echo '<h4>Tổng số: '.'<span class="text-danger">'.number_format($doanhthungay).'</span>'.' VNĐ</h4>'; }
                else{
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-sm-6 col-12 mb-2">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                   <h4 class="fw-bolder text-danger mb-0"><?=number_format($loadtongtien)?> VNĐ</h4>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  ...
                  <h5  class="mb-1 text-danger"> <?=number_format($doanhthuthangnow)  ?> VNĐ</h5> 
                  <p class="card-text text-muted font-small-2">
                   <span> Bán nhiều hơn tháng trước </span> <span class="fw-bolder text-danger"><?=round($in,2);?> %</span>
                  </p>
        ...
        <div class="card-body">         
          <div class="transaction-item">
            <div class="d-flex">
              ...
              <div class="fw-bolder text-success">+<?=number_format($thanhtoanbangtienmat)?> VNĐ</div>
          </div>
          <div class="transaction-item">
            <div class="d-flex">
  ...
  <div class="row match-height">
    ...
    <div class="col-12">
      <div class="card card-company-table">
        <div class="card-body p-0">
          <h2 class="text-center mt-2 fw-bold">Sản phẩm người dùng xem nhiều nhất</h2>
            ...
            <table class="table" id="myTable">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="fw-bolder"><?=$value['name_product']?></div>
                    </div>
                  </td>
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="avatar rounded">
                        <div class="avatar-content">
                          <img style="width:40px;" src="<?=$value['img']?>" alt="Toolbar svg" />
                        </div>
                      </div>
                    </div>  
                  </td>
                  <td class="text-nowrap">
                    <div class="d-flex flex-column">
                      <span class="fw-bolder mb-25"><?=$value['brand']?></span>
                    </div>
                  </td>
                  <td class="text-nowrap">
                    <div class="d-flex flex-column">
