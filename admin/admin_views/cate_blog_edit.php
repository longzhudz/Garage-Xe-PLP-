                                ...
                                <form id="form-add-blog" action="" method="POST"  >
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6 mb-2">
                                            ...
                                            <input name="name_cate" type="text" id="name_cate" value="<?=$get_id['name_cate']?>" class="form-control" placeholder="Tên danh mục">
                                        </div>
                                        <div class="col-md-6 col-12">
                                            ...
                                            <select name="status" class="form-select" id="blog-edit-status">
                                                ...
                                                <option value="0" 
                                                <?= (($get_id['status'] == 0) ? 'selected' : '') ?> 
                                                >Công khai</option>
                                                <option value="1"
                                                <?= (($get_id['status'] == 1) ? 'selected' : '') ?> 
                                                >Chỉ mình tôi</option>
                                            </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-12 mb-2">
                                            <button type="submit" onclick="return UpdateCate()" class="btn btn-outline-primary" id="save-cate-list"><i data-feather="save"></i>Uploads</button>
                                        </div>
                                    </div>
