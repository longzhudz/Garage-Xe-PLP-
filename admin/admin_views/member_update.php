            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form id="form-update-user" action="" method="POST" role="form" >
                                    ...
                                    <div class="col-sm-12 col-lg-12 mb-2">
                                        <button type="submit" onclick="return Upl()" class="btn btn-outline-primary" id="save-cate-list"><i data-feather="save"></i>Uploads</button>
                                    </div>
                                </form>
                            </div>
                        </div>
