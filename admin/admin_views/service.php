                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="./service.html">Quản lý Danh mục sản phẩm</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center ">
                                                <a class="btn btn-success me-1"href="./index.php?ctrl=service_update&id=<?=$value['id']?>"><i data-feather="edit"></i></a>
                                                <a class="btn btn-danger" onclick="return Del('<?= $value['name']?>')" href="./index.php?ctrl=service_delete&id=<?=$value['id']?>"><i  data-feather="delete"></i></a>
                                            </div>  
                                        </td>
                                    </tr>
                                <?php }?>
