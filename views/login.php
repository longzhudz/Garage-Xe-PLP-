        ...
        <div class="content-body"><div class="auth-wrapper auth-basic px-2">
            <div class="auth-inner my-2">
                ...
                <div class="card-body">
                    ...
                    <form class="auth-login-form mt-2" id="login_ajax_load" action="" method="">
                    <div class="mb-1">
                    ...
                    <button type="submit" id="login_button" class="btn btn-primary w-100" tabindex="4">Sign in</button>
                    </form>
