        ...
        <div class="content-body"><div class="auth-wrapper auth-basic px-2">
            <div class="auth-inner my-2">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-1">Welcome to PLP Soft Garage ! 👋</h4>
                    <p class="card-text mb-2">Đổi lại mật khẩu cho tài khoản</p>

                    <form class="auth-login-form mt-2" id="changepass" action="" method="">
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        <div class="d-flex justify-content-between">
                        <label class="form-label" for="login-password">Confirm</label>
                        </div>
                        <div class="input-group input-group-merge form-password-toggle">
                        <input
                            type="password"
                    ...
                    <button data-token=<?=$info['Token']?> data-user=<?=$info['UserID']?> id="changepass_button" class="btn btn-primary w-100" tabindex="4">Xác nhận</button>
                    </form>
