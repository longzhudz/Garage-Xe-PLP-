        ...
        <div class="content-body"><div class="auth-wrapper auth-basic px-2">
            <div class="auth-inner my-2">
                ...
                <div class="card-body">
                    ...
                    <form class="auth-forgot-password-form mt-2" id="forget" action="" method="">
                    <div class="mb-1">
                    ...
                    <button type="submit" id="forget_button" class="btn btn-primary w-100" >Lấy lại mật khẩu</button>
                    </form>

                    <p class="text-center mt-2">
                    <a href="login.html"> <i data-feather="chevron-left"></i> Quay về đăng nhập </a>
                    </p>
                </div>
                </div>
                <!-- /Forgot Password basic -->
